...
const LEAGUE_ICON_OPTIONS: { value: LeagueIcon; label: string; icon: JSX.Element }[] = [
    ...
    { value: 'checkerboard', label: 'Checkerboard', icon: <CheckerboardIcon size={20} /> },
    { value: 'coins', label: 'Coins', icon: <CoinsIcon size={20} /> },
    { value: 'confetti', label: 'Confetti', icon: <ConfettiIcon size={20} /> },
    { value: 'crown', label: 'Crown', icon: <CrownIcon size={20} /> },
    { value: 'detective', label: 'Detective', icon: <DetectiveIcon size={20} /> },
    { value: 'dice-three', label: 'Dice', icon: <DiceThreeIcon size={20} /> },
    { value: 'exam', label: 'Exam', icon: <ExamIcon size={20} /> },
    { value: 'fast-forward', label: 'Fast Forward', icon: <FastForwardIcon size={20} /> },
    { value: 'fire', label: 'Fire', icon: <FireIcon size={20} /> },
    { value: 'gift', label: 'Gift', icon: <GiftIcon size={20} /> },
    { value: 'globe', label: 'Globe', icon: <GlobeIcon size={20} /> },
    { value: 'graduation-cap', label: 'Graduation Cap', icon: <GraduationCapIcon size={20} /> },
    { value: 'hand-peace', label: 'Hand Peace', icon: <HandPeaceIcon size={20} /> },
    { value: 'magic-wand', label: 'Magic Wand', icon: <MagicWandIcon size={20} /> },
    { value: 'medal', label: 'Medal', icon: <MedalIcon size={20} /> },
    { value: 'megaphone', label: 'Megaphone', icon: <MegaphoneIcon size={20} /> },
    { value: 'microphone', label: 'Microphone', icon: <MicrophoneIcon size={20} /> },
    { value: 'moon-stars', label: 'Moon & Stars', icon: <MoonStarsIcon size={20} /> },
    { value: 'music-notes', label: 'Music Notes', icon: <MusicNotesIcon size={20} /> },
    { value: 'package', label: 'Package', icon: <PackageIcon size={20} /> },
    { value: 'paint-brush', label: 'Paint Brush', icon: <PaintBrushIcon size={20} /> },
    { value: 'paw-print', label: 'Paw Print', icon: <PawPrintIcon size={20} /> },
    { value: 'phone', label: 'Phone', icon: <PhoneIcon size={20} /> },
    { value: 'piano-keys', label: 'Piano Keys', icon: <PianoKeysIcon size={20} /> },
    { value: 'shooting-star', label: 'Shooting Star', icon: <ShootingStarIcon size={20} /> },
    { value: 'siren', label: 'Siren', icon: <SirenIcon size={20} /> },
    { value: 'sparkle', label: 'Sparkle', icon: <SparkleIcon size={20} /> },
    { value: 'star', label: 'Star', icon: <StarIcon size={20} /> },
    { value: 'student', label: 'Student', icon: <StudentIcon size={20} /> },
    { value: 'trophy', label: 'Trophy', icon: <TrophyIcon size={20} /> },
    { value: 'unicorn', label: 'Unicorn', icon: <UnicornIcon size={20} /> },
    { value: 'yin-yang', label: 'Yin Yang', icon: <YinYangIcon size={20} /> }
];
