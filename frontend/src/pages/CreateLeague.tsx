...
const LEAGUE_ICON_OPTIONS: { value: LeagueIcon; label: string; icon: JSX.Element }[] = [
    ...
    { value: 'evergreen-tree', label: 'Evergreen Tree', icon: <EvergreenTreeIcon size={20} /> },
    ...
    { value: 'palette', label: 'Palette', icon: <PaletteIcon size={20} /> },
    ...
    { value: 'snowflake', label: 'Snowflake', icon: <SnowflakeIcon size={20} /> },
